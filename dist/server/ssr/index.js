import { i as __toESM, n as __commonJSMin, t as require_react } from "./assets/react-DX6OWF7o.js";
import { _ as VINEXT_CACHE_HEADER, c as setNavigationContext, d as useServerInsertedHTML, f as isHashOnlyBrowserUrlChange, h as AppElementsWire, i as clearServerInsertedHTML, m as toSameOriginAppPath, n as ServerInsertedHTMLContext, p as toBrowserNavigationHref, r as _registerStateAccessors, s as renderServerInsertedHTML, t as GLOBAL_ACCESSORS_KEY, v as stripBasePath } from "./assets/navigation-ZXiI9wZP.js";
import { n as Slot, t as ElementsContext } from "./assets/slot-BF9MybkK.js";
...
function getOrCreateAls(key) {
	...
	return _g$10[sym] ??= new AsyncLocalStorage$1();
}
//#endregion
...
*/
var _FALLBACK_KEY$6 = Symbol.for("vinext.navigation.fallback");
var _g$8 = globalThis;
var _als$6 = getOrCreateAls("vinext.navigation.als");
var _fallbackState$5 = _g$8[_FALLBACK_KEY$6] ??= {
	serverContext: null,
	serverInsertedHTMLCallbacks: []
};
function _getState$4() {
	if (isInsideUnifiedScope()) return getRequestContext();
	return _als$6.getStore() ?? _fallbackState$5;
}
...
function runWithServerInsertedHTMLState(fn) {
	...
	const state = {
		serverContext: (_als$6.getStore() ?? _fallbackState$5).serverContext,
		serverInsertedHTMLCallbacks: []
	};
	return _als$6.run(state, fn);
}
var _accessors = {
	getServerContext() {
		return _getState$4().serverContext;
	},
	setServerContext(ctx) {
		_getState$4().serverContext = ctx;
	},
	getInsertedHTMLCallbacks() {
		return _getState$4().serverInsertedHTMLCallbacks;
	},
	clearInsertedHTMLCallbacks() {
		_getState$4().serverInsertedHTMLCallbacks = [];
	}
};
...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DT8DN1Jt.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-B3gTnUv3.js");
		return {
			get "ErrorBoundary"() {
	...
	"8c0f216c4604": async () => {
		const m = await import("./assets/slot-BF9MybkK.js").then((n) => n.r);
		return {
			get "Children"() {
				return m["Children"];
			},
	...
	"96d64da4a948": async () => {
		const m = await import("./assets/rupee-lens-CUANQHgT.js");
		return { get "RupeeLens"() {
			return m["RupeeLens"];
		} };
	}
};
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("./assets/react-DX6OWF7o.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1))).default;
		assertStillCurrent();
...
*/
var _als$5 = getOrCreateAls("vinext.requestContext.als");
...
var _FALLBACK_KEY$5 = Symbol.for("vinext.nextHeadersShim.fallback");
var _g$7 = globalThis;
...
var _FALLBACK_KEY$4 = Symbol.for("vinext.cache.fallback");
var _g$6 = globalThis;
var _cacheAls = getOrCreateAls("vinext.cache.als");
_g$6[_FALLBACK_KEY$4] ??= {
	actionRevalidationKind: 0,
	requestScopedCacheLife: null,
	unstableCacheRevalidation: "foreground"
};
...
_g$5[_PRIVATE_FALLBACK_KEY] ??= { _privateCache: /* @__PURE__ */ new Map() };
...
var _FALLBACK_KEY$3 = Symbol.for("vinext.fetchCache.fallback");
var _g$4 = globalThis;
var _als$3 = getOrCreateAls("vinext.fetchCache.als");
var _noop = () => {};
...
var _fallbackState$3 = _g$4[_FALLBACK_KEY$3] ??= {
	currentRequestTags: [],
	currentFetchSoftTags: [],
	currentFetchCacheMode: null,
	isFetchDedupeActive: false,
...
function createPatchedFetch() {
	return async function patchedFetch(input, init) {
		...
		const cacheDirective = resolveSegmentCacheDirective(getFetchCacheDirective(input, init), nextOpts, _getState$3().currentFetchCacheMode);
		...
		const softTags = _getState$3().currentFetchSoftTags;
		...
		const reqTags = _getState$3().currentRequestTags;
		if (tags.length > 0) {
...
*/
var _FALLBACK_KEY$2 = Symbol.for("vinext.router.fallback");
var _g$3 = globalThis;
var _als$2 = getOrCreateAls("vinext.router.als");
var _fallbackState$2 = _g$3[_FALLBACK_KEY$2] ??= { ssrContext: null };
...
_registerRouterStateAccessors({
	getSSRContext() {
		return _getState$2().ssrContext;
	},
	setSSRContext(ctx) {
		_getState$2().ssrContext = ctx;
	}
});
//#endregion
...
async function buildPagesShellHtml(bodyMarker, fontHeadHTML, nextDataScript, options) {
	if (options.DocumentComponent) {
		let html = await options.renderDocumentToString(import_react.createElement(options.DocumentComponent));
...
async function renderPagesPageResponse(options) {
	const pageElement = withScriptNonce(import_react.createElement(import_react.Fragment, null, options.createPageElement(options.pageProps)), options.scriptNonce);
...
var buildId = "9c792b20-9427-4109-859f-13d8c0c07c0e";
var vinextConfig = {
	"basePath": "",
	"trailingSlash": false,
	"redirects": [],
...
async function renderToStringAsync(element) {
	const stream = await (0, import_server_edge.renderToReadableStream)(element);
...
var _apiRouteTrie = buildRouteTrie([]);
		...
		try {
			...
			const pageDataResult = await resolvePagesPageData({
				...
				createPageElement(currentPageProps) {
					return wrapWithRouterContext(import_react.createElement(PageComponent, currentPageProps));
				},
			...
			return renderPagesPageResponse({
				...
				renderToReadableStream(element) {
					return (0, import_server_edge.renderToReadableStream)(element);
				},
...
//#endregion
export { app_ssr_entry_default as default, handleSsr, pageRoutes, renderPage };
