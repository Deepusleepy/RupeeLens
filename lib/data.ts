...
const ministrySeries: Record<string, number[]> = {
  ...
  Defence: [285005, 293920, 340922, 346716.77, 385352.88, 413544, 436787, 459474.71, 500053, 595320, 621940.85],
  Finance: [612000, 655000, 728000, 792000, 865000, 980000, 1149000, 1200000, 1368000, 1571000, 1858158.52],
